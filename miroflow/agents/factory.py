...
#z 加载agent类：IterativeAgentWithToolAndRollback,InputMessageGenerator,SummaryGenerator,FinalAnswerExtractor
def build_agent(cfg: Union[DictConfig, dict], sequential: bool = False) -> BaseAgent:
    ...
    logger.info(f'z# build_agent:module_class={module_class}')
