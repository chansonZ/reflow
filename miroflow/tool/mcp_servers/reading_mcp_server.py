...
SERPER_API_KEY = os.environ.get("SERPER_API_KEY", "") # z:对于文件来说，不需要
...
async def read_file(uri: str) -> str:
    ...
    server_params = StdioServerParameters(
        command="uv",
        args=["run", "--active", "--", "markitdown-mcp"], # z: markitdown-mcp 是已经安装好的一个python包
    )
